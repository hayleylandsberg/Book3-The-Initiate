...
const emailList = customers.customers.map(function (element) {
    let array = element.contacts.email
    return array
})
console.log(emailList)

// const oneArray = emailList[0].concat(emailList[1], emailList[2], emailList[3], emailList[4], emailList[5], emailList[6], emailList[7], emailList[8], emailList[9])
...
//     currentCustomers.contacts.email.forEach(currentEmail => allEmails.push(currentEmail))
// })
